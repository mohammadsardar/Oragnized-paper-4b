---
title: "Predicting the US 2020 election vote"
...
We can see from \@ref(votersagepoll) the way that age was distributed in the UCLA and ACS data. We have a smaller proportion for ACS because there were a number of observations that were from respondents that had not yet turned 18 and hence could not vote.
...
From the graph above we can see that respondents race is equally distributed across the two datasets. With the only differences being a slight increase in 'other' races for the post stratification dataset, and a slight increase in 'white' for the polling datset.
